...
class User {
  ...
  /**
   * Gets the floor request queue of this User. The FloorRequest messages
   * are answered in FIFO order.
   * @return {bfcp-lib.Message[]} The floor request messages list
   */
  ...
  /**
   * Gets the floor release queue of this User. The FloorRelease messages
   * are answered in FIFO order.
   * @return {bfcp-lib.Message[]} The floor release messages list
   */
